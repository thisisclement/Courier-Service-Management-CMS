...
/* ----------------------------------------------------------- START OF JQUERY --------------------------------------------------------- */
      ...
      function sendSMS(){ 
        ...
        $.ajax({
          type: 'POST',
          url: '/courier/clem/wordpress/wp-content/themes/spacious-child/sendSMS.php',
      ...
      $('#verifyForm').submit(function(e) {
        ...
        $.ajax({
          type: 'POST',
          url: '/courier/clem/wordpress/wp-content/themes/spacious-child/verifyKey.php',
      ...
      $(form).submit(function(e) {
        ...
        $.ajax({
          type: 'POST',
          url: '/courier/clem/wordpress/wp-content/themes/spacious-child/formProcess.php',
          data: formData,
          success: function(){
